    ...
    return (
        <section id='projects' className='bg-myDarkGray body-font pb-16 rounded-2xl'>
            <div className='container px-10 py-10 mx-auto'>
                ...
                <h5 className='text-myButtonFill font-bold xl:text-2xl md:text-lg mb-2 text-shadow bg-myGray2 xl:w-44 rounded-xl py-1 px-3 xl:px-5 w-32 xl:mb-4'>PORTFOLIO</h5>
