        ...
        <section id='about'>
            <div className='flex xl:flex-row flex-col items-center'>
                <div className='container px-10 py-10 mx-auto md:flex md:flex-row-reverse w-full justify-start'>
                    ...
                    <h5 className='text-myBlue font-bold xl:text-2xl text-lg mb-2 text-shadow bg-myButtonFill xl:w-36 rounded-xl py-1 px-4 xl:px-5 w-24 xl:m-0'>ABOUT</h5>
                        <div className='flex items-center'>
                            <h1 className='title-font lg:text-6xl xl:mb-4 text-4xl font-black text-myDarkGray relative'>
                                Who I am ?
                            </h1>
