        ...
        <section id='contact' className='relative'>
            <div className='flex md:flex-row flex-col items-center min-h-screen'>
                <div className='container px-5 py-10 mx-auto flex flex-col sm:flex-nowrap flex-wrap '>
                    <h5 className='text-myYellow font-semibold text-2xl mb-2 ml-2'>HIRE ME</h5>
                    <h1 className='title-font lg:text-7xl sm:text-4xl text-3xl font-extrabold text-myDarkGray relative'>
                        CONTACT
                    </h1>
                    <div className='flex bg-white rounded-3xl p-4 mt-4 w-full'>
                        <div className='flex flex-col pl-8 p-6 bg-myYellow w-1/3  rounded-2xl overflow-hidden relative'>
                            ...
                            <div>
                                ...
                                >
                                <BsWhatsapp className=' text-myDarkGray' />
                                <span className=' text-myDarkGray'> +54 11 3431 1774</span>
                                </a>
                            </div>
                        ...
                        >
                            ...
                            <button
                                type='submit'
                                value='Send'
                                className='hover:bg-myYellowDark mt-10 self-end w-2/5 h-14 text-myWhite bg-myYellow border-0 py-2 px-6 focus:outline-none rounded-xl text-lg'
                            >
                                Send Message
                            </button>
                        </form>
