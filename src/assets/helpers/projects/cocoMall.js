...
function CocoMall() {
    return (
        <div className='flex relative items-center min-h-screen'>
            <span className='absolute top-6 md:top-16 md:left-1/4 left-2'>
                <Link to='/'>
                    <BsFillArrowLeftCircleFill className='h-8 w-8 text-myDarkGray hover:text-myBlue' />
                </Link>
            </span>
            <div className='flex flex-col container px-5 py-5 mx-auto items-center  md:w-2/3 h-full'>
                <div className='flex items-center gap-5 relative '>
                    <h2 className='title-font lg:text-5xl sm:text-4xl text-3xl mb-4 pl-3 font-extrabold text-myDarkGray relative'>
                        COCO mall
                    </h2>
                    <span className='text-myBlue font-bold text-shadow'>Marketplace</span>
                </div>
                <div className='flex relative md:w-2/3 justify-center'>
                    <iframe
                    ...
                    <div>
                        ...
                        <div className='flex flex-col mt-4'>
                            ...
                            <p className='text-justify px-2'>
                                ...
                                management with GitHub and the discussions of how we were going to
                                organize the tasks. It is a project where I learned a lot and had
                                fun doing it.
                            </p>
                        </div>
                    </div>
